...
with st.container():
    ...
    with right_column:
        st_lottie(lottie_coding, height=450, key="Industrial coding")

with st.container():
    st.write("---")
    st.header("Formation", anchor=False)
    left_column, right_column = st.columns(2)
    with left_column:
        st_lottie(lottie_Master, height=450, key="Industrial Master")
    with right_column:
...
with st.container():
    ...
    left_column, right_column = st.columns(2)
    with right_column:
        st_lottie(lottie_Bachelor, height=450, key="Industrial Bachelor")
    with left_column:

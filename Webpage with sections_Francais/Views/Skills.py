...
with st.container():
    ...
    with right_column:
        st_lottie(lottie_coding_1_2, height=400, key="Industrial coding_1_2")

with st.container():
    left_column, right_column = st.columns(2)
    with left_column:
        st_lottie(lottie_coding_3_4, height=400, key="Industrial coding_3_4")
    with right_column:
...
with st.container():
    ...
    with right_column:
        st_lottie(lottie_coding_5_6, height=400, key="Industrial coding_5_6")

st.markdown("<h3><u>Compétences techniques :</u></h3>", unsafe_allow_html=True)
with st.container():
    left_column, right_column = st.columns(2)
    with left_column:
        st_lottie(lottie_coding_7_8, height=550, key="Industrial coding_7_8")
    with right_column:
...
with st.container():
    ...
    with right_column:
        st_lottie(lottie_coding_9_10, height=550, key="Industrial coding_9_10")

with st.container():
    left_column, right_column = st.columns(2)
    with left_column:
        st_lottie(lottie_coding_11_12, height=500, key="Industrial coding_11_12")
    with right_column:
